		...
		<div id="container">
			...
			<header role="banner" class="header">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<p id="logo"><a href="<?php echo home_url(); ?>" rel="nofollow"><img alt="<?php bloginfo('name'); ?>" title="<?php bloginfo('description'); ?>" src="<?php bloginfo('template_directory'); ?>/images/logo.png" /></a></p>
