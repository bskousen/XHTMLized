...
function formatDateDB (input) {
       ...
       if (cadena[2] == 'Enero,')  { var month = '01'; }
       else if (cadena[2] == 'Febrero,')  { var month = '02'; }
       else if (cadena[2] == 'Marzo,')  { var month = '03'; }
       else if (cadena[2] == 'Abril,')  { var month = '04'; }
       else if (cadena[2] == 'Mayo,')  { var month = '05'; }
       else if (cadena[2] == 'Junio,')  { var month = '06'; }
       else if (cadena[2] == 'Julio,')  { var month = '07'; }
       else if (cadena[2] == 'Agosto,')  { var month = '08'; }
       else if (cadena[2] == 'Septiembre,')  { var month = '09'; }
       else if (cadena[2] == 'Octubre,')  { var month = '10'; }
       else if (cadena[2] == 'Npviembre,')  { var month = '11'; }
       else if (cadena[2] == 'Diciembre,')  { var month = '12'; }
