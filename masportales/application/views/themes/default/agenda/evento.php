<div id="events" class="section">
  ...
  <div class="content event">
  	...
  	<div class="event-date">
  		<span class="event-day"><?php echo fecha($data['event']['event_start'], 'day'); ?></span> 
  		<span class="event-month"><?php echo fecha($data['event']['event_start'], 'monthname'); ?></span> 
  		<span class="event-year"><?php echo fecha($data['event']['event_start'], 'year'); ?></span>
  	</div>
  	
  	<h3><a href="<?php echo _reg('site_url'); ?>agenda/<?php echo $data['event']['slug']; ?>"><?php echo $data['event']['title']; ?></a></h3>
    <?php if($data['event']['have_comment']) : ?>
    <a href="http://demo.masportales.es/agenda/<?php echo $data["event"]["slug"] ?>#comments" class="comments">
       <img src="http://demo.masportales.es/images/icon_comments.png" alt="comentarios">
      <span>(<?php echo $data["event"]["comment_number"] ?> comentarios)</span>
    </a>
    <?php endif; ?>
  	<?php if (isset($data['event']['image'])): ?>
  		<img src="<?php echo get_image_url($data['event']['image'], '', _reg('site_url') . 'usrs/events/'); ?>" alt="<?php echo $data['event']['title']; ?>" class="photo" />
  	<?php endif; ?>
  	<div class="excerpt"><?php echo $data['event']['content']; ?></div>
  	...
  	<?php else: ?>
  		<p>No se encuentra el evento indicado.</p>
  	<?php endif; ?>
...
<?php if ($data['comments']): ?>
    ...
    <div id="send-comment" class="content">
        ...
        <form action="<?php echo _reg('site_url') . 'agenda/save_comment' ?>" method="post"> 
            ...
            <input type="hidden" name="agenda_id" value="<?php echo $data['event']['event_ID']; ?>" />
